...
Notably, RL's most successful recent application may not be games, but [LLM alignment]({{ site.baseurl }}/en/llm-alignment-part1/)—see Parts 5 and 6 of this series.
...
3. **Trajectory expectation**: $J(\pi) = \mathbb{E}\_{\tau \sim \pi} \left[ \sum\_{t=0}^{T} \gamma^t r\_t \right]$
...
<!-- tikz-source: rl-methods-tree-en
\begin{tikzpicture}[
...
\end{tikzpicture}
-->
![RL Methods Classification]({{ site.baseurl }}/assets/figures/rl-methods-tree-en.svg)
